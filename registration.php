...
<table width="586" border="0">
  ...
  <tr>
    ...
    <td colspan="3"><span style='color:darkgreen;'><font size="3"><b>To complete registration kindly login with your registered email id & password and upload your final paper.</span></td>
    </tr>
  <tr>
    <td style='font-weight:bold;width:170px;'>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
