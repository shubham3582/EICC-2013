...
<table class="sidemenuQuick" cellspacing=0>
  ...
  <tr>
    <td class="styleqck" align=center colspan=2><a href='http://www.galgotias.in' target='_blank'><img src="http://eiccit.org/img/gp.jpg" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.galgotias.in')"></a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="styleqck" align=center><img src="http://eiccit.org/img/srikesar logo1.jpg" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.srikesar.com')"></td>
    </tr>
...
<div id="DivMovingLayer" style="width: 150px; position: absolute; left: 120px; top: 30px;display: block;border: solid 1px gray;">
...
<tr>
  ...
  <tr>
    <td class="styleqck" align=center><img src="http://eiccit.org/img/radio__2.jpg" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.radionoida.fm/')"></td>
    </tr>
					 <tr>
	<td align="center" bgcolor="#DDDDDD" colspan=2><b class="v1"><u><br></u></b></td>
  </tr>
  <tr>
    <td class="styleqck" align=center><img src="http://eiccit.org/img/h.jpg" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.hindustantimes.com/')"></td>
    </tr>
					<tr>
	<td align="center" bgcolor="#DDDDDD" colspan=2><b class="v1"><u><br></u></b></td>
  </tr>
  <tr>
    <td class="styleqck" align=center><img src="http://eiccit.org/img/d.gif" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.jagran.com/')"></td>
    </tr>
    <tr>
	<td align="center" bgcolor="#DDDDDD" colspan=2><b class="v1"><u><br></u></b></td>
  </tr>
  ...
  <tr>
    <td class="styleqck" align=center><img src="http://eiccit.org/img/heart.jpg" width=130 height=100 onmouseover="this.style.cursor='hand'" onclick="javascript:window.open('http://www.heartplus.in/')"></td>
    </tr>
				</tbody></table>
